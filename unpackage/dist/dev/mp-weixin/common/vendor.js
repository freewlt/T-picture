...
/***/ 25:
/*!***************************************************************!*\
  !*** E:/MyWorkSpaces/myself/exercise/T-picture/utils/http.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {// import api from '../config/apiBaseUrl.js';

var Bmob = __webpack_require__(/*! ./Bmob-1.6.1.min.js */ 26);
...
// 封装请求
function request(url, method, data) {var config = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
...
function formatCardId(params) {
  var data = params.replace(/\s/g, '').replace(/(\d{4})\d+(\d{4})$/, "$1 **** **** $2");
  return data;
}
...
module.exports = {
  ...
  login: function login(data) {
    return (0, _http.request)('/current', 'post', data);
  },

  maUserInfo: function maUserInfo(data) {
    return (0, _http.request)('/api-aus/oauth/wxMaUserInfo/token', 'post', data,
    {
  ...
  // 微信登录
  maMobile: function maMobile(data) {
    return (0, _http.request)('/api-aus/oauth/wxMaMobile/token', 'post', data,
    {
      "Authorization": "Basic bWVtYmVyX21hOm1lbWJlcl9tYQ==" });
  ...
  // 会员信息
  memberList: function memberList(data) {
    return (0, _http.request)('/api-member/wxMember/member/info', 'get', data
    // {
  ...
  getList: function getList(data) {
    return (0, _http.request)('/api-base/organizational/wx/list', 'get', data, {
      selfHandleErr: JSON.stringify(true) });

  },

  // 会员绑卡列表
  getCarBag: function getCarBag(data) {
    return (0, _http.request)('/api-member/member-bind-card/member-bind-list', 'get', data);
  },
  // 会员绑卡
  memberBindCard: function memberBindCard(data) {
    return (0, _http.request)('/api-member/member-bind-card/bind/ring?mobilePhone=' + data.mobilePhone +
  ...
  // 会员绑车环
  memberBindRing: function memberBindRing(data) {
    return (0, _http.request)('/api-member/member-bind-card/bind/ring?mobilePhone=' + data.mobilePhone +
  ...
  // 解绑
  removeBind: function removeBind(data) {
    return (0, _http.request)('/api-member/member-bind-card/un-bind/', 'get', data);
  },

  // 单位主卡卡片
  companyCardList: function companyCardList(data) {
    return (0, _http.request)('/api-member/member-bind-card/card/info', 'get', data);
  },

  // 查询车环详情
  carRingDetail: function carRingDetail(data) {
    return (0, _http.request)('/api-member/member-bind-card/ring/info', 'get', data);
  },

  // 加油记录
  oilRecordList: function oilRecordList(data) {
    return (0, _http.request)('/api-trade/transactions/ring/', 'get', data
    // {
    //     "Content-Type": "application/x-www-form-urlencoded"
    // }
    );
  ...
  // 验证码
  getVerify: function getVerify(data) {
    return (0, _http.request)('/api-member/member-bind-card/captcha', 'get', data);
  },

  // 个人资料
  getPersonal: function getPersonal(data) {
    return (0, _http.request)('/api-member/wxMember/member/personal', 'get', data);
  },
  // 性别
  getSex: function getSex(data) {
    return (0, _http.request)('/api-member/wxMember/member/sex', 'post', data);
  },
  // 生日
  getBirthday: function getBirthday(data) {
    return (0, _http.request)('/api-member/wxMember/member/birthday', 'post', data);
  },
  // 免密
  switchPwd: function switchPwd(data) {
    return (0, _http.request)('/api-member/wxMember/member/password-switch', 'post', data);
  },
  // 设置密码
  setPwd: function setPwd(data) {
    return (0, _http.request)('/api-member/wxMember/member/password', 'post', data);
  },


  // 车环系统单位主卡下的附属卡
  ringChildrenList: function ringChildrenList(data) {
    return (0, _http.request)('/api-member/member-bind-card/ring/children-list', 'get', data);
  },

  // 卡系统单位主卡下的附属卡
  cardChildrenList: function cardChildrenList(data) {
    return (0, _http.request)('/api-member/member-bind-card/card/children-list', 'get', data);
  },

  // 车环系统消费记录
  consumesRecordList: function consumesRecordList(data) {
    return (0, _http.request)('/api-trade/consumes/records', 'get', data);
  },
  // 单位卡下车环系统卡片信息
  childrenRingInfo: function childrenRingInfo(data) {
    return (0, _http.request)('/api-member/member-bind-card/children/ring/info/', 'get', data);
  },

  // 卡系统附属卡加油记录
  consumeDetailed: function consumeDetailed(data) {
    return (0, _http.request)('/api-member/member-bind-card/card/consume-detailed', 'get', data);
  },
  // 卡系统附属卡片信息
  childrenCardInfo: function childrenCardInfo(data) {
    return (0, _http.request)('/api-member/member-bind-card/children/card/info/', 'get', data);
  } };
...
/***/ 4:
/*!************************************************************!*\
  !*** E:/MyWorkSpaces/myself/exercise/T-picture/pages.json ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
